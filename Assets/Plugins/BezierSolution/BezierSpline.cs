...
namespace BezierSolution
{
	...
	public class BezierSpline : MonoBehaviour
	{
		...
		public AnimationCurve influenceWidth = AnimationCurve.Linear( 0, 1, 1, 1 );
		...
		public Vector3 GetNormal ( float normalizedT ) {
			var tan = GetTangent( normalizedT ).normalized;

			var cross = Vector3.Cross( tan, Vector3.forward );
